        ...
        <Fragment>
            <div className="sidebar-option-content-wrp">
               <div className="content-box">
                ...
                <p>{__( 'You’re using the free version of the Vayu X Theme with limited features and functionality. You can upgrade to Blockline Pro Theme for Advanced features, Custom Sections, and more useful options to customize your website easily.', 'blockline' )}</p>
