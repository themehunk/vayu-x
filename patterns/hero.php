...
<div class="wp-block-group alignfull has-bg-prim-background-color has-background"><!-- wp:cover {"url":"' . esc_url( VAYU_X_URL . 'assets/images/').'bg.png","id":23,"hasParallax":true,"dimRatio":20,"overlayColor":"bg-prim","isDark":false,"align":"full","style":{"spacing":{"padding":{"right":"390px","left":"390px"}}},"layout":{"type":"default"}} -->
<div class="wp-block-cover alignfull is-light has-parallax" style="padding-right:390px;padding-left:390px"><span aria-hidden="true" class="wp-block-cover__background has-bg-prim-background-color has-background-dim-20 has-background-dim"></span><div role="img" class="wp-block-cover__image-background wp-image-23 has-parallax" style="background-position:50% 50%;background-image:url(' . esc_url( VAYU_X_URL . 'assets/images/').'bg.png)"></div><div class="wp-block-cover__inner-container"><!-- wp:group {"align":"wide","style":{"dimensions":{"minHeight":""},"spacing":{"padding":{"right":"0","left":"0","top":"90px","bottom":"90px"}}},"layout":{"type":"flex","orientation":"vertical","justifyContent":"center","verticalAlignment":"center"}} -->
